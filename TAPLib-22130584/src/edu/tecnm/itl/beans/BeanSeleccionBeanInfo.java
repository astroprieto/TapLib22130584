 ...
 * @author rami
 */
public class BeanSeleccionBeanInfo extends SimpleBeanInfo
{

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( edu.tecnm.itl.beans.SeleccionBean.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_colorPanel = 12;
    ...
    private static final int PROPERTY_contadorDisponiblesLabel = 19;
    private static final int PROPERTY_contadorSeleccionadosLabel = 20;
    ...
    private static final int PROPERTY_disponibleLabel = 26;
    ...
    private static final int PROPERTY_listaDisponible = 61;
    private static final int PROPERTY_listaSeleccionado = 62;
    ...
    private static final int PROPERTY_mixingCutoutShape = 71;
    ...
    private static final int PROPERTY_moverDerechaLabel = 76;
    private static final int PROPERTY_moverDerechaTodoLabel = 77;
    private static final int PROPERTY_moverIzquierdaLabel = 78;
    private static final int PROPERTY_moverIzquierdaTodoLabel = 79;
    ...
    private static final int PROPERTY_seleccionadoLabel = 93;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", edu.tecnm.itl.beans.SeleccionBean.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", edu.tecnm.itl.beans.SeleccionBean.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", edu.tecnm.itl.beans.SeleccionBean.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", edu.tecnm.itl.beans.SeleccionBean.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", edu.tecnm.itl.beans.SeleccionBean.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", edu.tecnm.itl.beans.SeleccionBean.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", edu.tecnm.itl.beans.SeleccionBean.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", edu.tecnm.itl.beans.SeleccionBean.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", edu.tecnm.itl.beans.SeleccionBean.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", edu.tecnm.itl.beans.SeleccionBean.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", edu.tecnm.itl.beans.SeleccionBean.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", edu.tecnm.itl.beans.SeleccionBean.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_colorPanel] = new PropertyDescriptor ( "colorPanel", edu.tecnm.itl.beans.SeleccionBean.class, "getColorPanel", "setColorPanel" ); // NOI18N
            properties[PROPERTY_colorPanel].setPreferred ( true );
            properties[PROPERTY_colorPanel].setDisplayName ( "Color del fondo" );
            properties[PROPERTY_colorPanel].setShortDescription ( "Cambia el color del fondo" );
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", edu.tecnm.itl.beans.SeleccionBean.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", edu.tecnm.itl.beans.SeleccionBean.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", edu.tecnm.itl.beans.SeleccionBean.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", edu.tecnm.itl.beans.SeleccionBean.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", edu.tecnm.itl.beans.SeleccionBean.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", edu.tecnm.itl.beans.SeleccionBean.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_contadorDisponiblesLabel] = new PropertyDescriptor ( "contadorDisponiblesLabel", edu.tecnm.itl.beans.SeleccionBean.class, "getContadorDisponiblesLabel", "setContadorDisponiblesLabel" ); // NOI18N
            properties[PROPERTY_contadorDisponiblesLabel].setPreferred ( true );
            properties[PROPERTY_contadorDisponiblesLabel].setDisplayName ( "Etiqueta del contador Disponibles" );
            properties[PROPERTY_contadorSeleccionadosLabel] = new PropertyDescriptor ( "contadorSeleccionadosLabel", edu.tecnm.itl.beans.SeleccionBean.class, "getContadorSeleccionadosLabel", "setContadorSeleccionadosLabel" ); // NOI18N
            properties[PROPERTY_contadorSeleccionadosLabel].setPreferred ( true );
            properties[PROPERTY_contadorSeleccionadosLabel].setDisplayName ( "Etiqueta del contador seleccionados" );
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", edu.tecnm.itl.beans.SeleccionBean.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", edu.tecnm.itl.beans.SeleccionBean.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", edu.tecnm.itl.beans.SeleccionBean.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", edu.tecnm.itl.beans.SeleccionBean.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", edu.tecnm.itl.beans.SeleccionBean.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_disponibleLabel] = new PropertyDescriptor ( "disponibleLabel", edu.tecnm.itl.beans.SeleccionBean.class, "getDisponibleLabel", "setDisponibleLabel" ); // NOI18N
            properties[PROPERTY_disponibleLabel].setPreferred ( true );
            properties[PROPERTY_disponibleLabel].setDisplayName ( "Etiqueta de Disponible" );
            properties[PROPERTY_disponibleLabel].setShortDescription ( "Modifica la etiqueta de disponible" );
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", edu.tecnm.itl.beans.SeleccionBean.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", edu.tecnm.itl.beans.SeleccionBean.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", edu.tecnm.itl.beans.SeleccionBean.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", edu.tecnm.itl.beans.SeleccionBean.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", edu.tecnm.itl.beans.SeleccionBean.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", edu.tecnm.itl.beans.SeleccionBean.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", edu.tecnm.itl.beans.SeleccionBean.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", edu.tecnm.itl.beans.SeleccionBean.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", edu.tecnm.itl.beans.SeleccionBean.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", edu.tecnm.itl.beans.SeleccionBean.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", edu.tecnm.itl.beans.SeleccionBean.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", edu.tecnm.itl.beans.SeleccionBean.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", edu.tecnm.itl.beans.SeleccionBean.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", edu.tecnm.itl.beans.SeleccionBean.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", edu.tecnm.itl.beans.SeleccionBean.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", edu.tecnm.itl.beans.SeleccionBean.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", edu.tecnm.itl.beans.SeleccionBean.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", edu.tecnm.itl.beans.SeleccionBean.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", edu.tecnm.itl.beans.SeleccionBean.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", edu.tecnm.itl.beans.SeleccionBean.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", edu.tecnm.itl.beans.SeleccionBean.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", edu.tecnm.itl.beans.SeleccionBean.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", edu.tecnm.itl.beans.SeleccionBean.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", edu.tecnm.itl.beans.SeleccionBean.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", edu.tecnm.itl.beans.SeleccionBean.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", edu.tecnm.itl.beans.SeleccionBean.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", edu.tecnm.itl.beans.SeleccionBean.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", edu.tecnm.itl.beans.SeleccionBean.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", edu.tecnm.itl.beans.SeleccionBean.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", edu.tecnm.itl.beans.SeleccionBean.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", edu.tecnm.itl.beans.SeleccionBean.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", edu.tecnm.itl.beans.SeleccionBean.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", edu.tecnm.itl.beans.SeleccionBean.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", edu.tecnm.itl.beans.SeleccionBean.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_listaDisponible] = new PropertyDescriptor ( "listaDisponible", edu.tecnm.itl.beans.SeleccionBean.class, "getListaDisponible", "setListaDisponible" ); // NOI18N
            properties[PROPERTY_listaDisponible].setPreferred ( true );
            properties[PROPERTY_listaDisponible].setDisplayName ( "Lista de Disponible" );
            properties[PROPERTY_listaDisponible].setShortDescription ( "Modifica y añade" );
            properties[PROPERTY_listaSeleccionado] = new PropertyDescriptor ( "listaSeleccionado", edu.tecnm.itl.beans.SeleccionBean.class, "getListaSeleccionado", "setListaSeleccionado" ); // NOI18N
            properties[PROPERTY_listaSeleccionado].setPreferred ( true );
            properties[PROPERTY_listaSeleccionado].setDisplayName ( "Lista de Seleccionado" );
            properties[PROPERTY_listaSeleccionado].setShortDescription ( "Añade y modifica los elementos de la lista" );
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", edu.tecnm.itl.beans.SeleccionBean.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", edu.tecnm.itl.beans.SeleccionBean.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", edu.tecnm.itl.beans.SeleccionBean.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", edu.tecnm.itl.beans.SeleccionBean.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", edu.tecnm.itl.beans.SeleccionBean.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", edu.tecnm.itl.beans.SeleccionBean.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", edu.tecnm.itl.beans.SeleccionBean.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", edu.tecnm.itl.beans.SeleccionBean.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mixingCutoutShape] = new PropertyDescriptor ( "mixingCutoutShape", edu.tecnm.itl.beans.SeleccionBean.class, null, "setMixingCutoutShape" ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", edu.tecnm.itl.beans.SeleccionBean.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", edu.tecnm.itl.beans.SeleccionBean.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", edu.tecnm.itl.beans.SeleccionBean.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", edu.tecnm.itl.beans.SeleccionBean.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_moverDerechaLabel] = new PropertyDescriptor ( "moverDerechaLabel", edu.tecnm.itl.beans.SeleccionBean.class, "getMoverDerechaLabel", "setMoverDerechaLabel" ); // NOI18N
            properties[PROPERTY_moverDerechaLabel].setPreferred ( true );
            properties[PROPERTY_moverDerechaLabel].setDisplayName ( "Etiqueta de Mover a la Derecha" );
            properties[PROPERTY_moverDerechaLabel].setShortDescription ( "Edita la etiqueta de Mover a la Derecha" );
            properties[PROPERTY_moverDerechaTodoLabel] = new PropertyDescriptor ( "moverDerechaTodoLabel", edu.tecnm.itl.beans.SeleccionBean.class, "getMoverDerechaTodoLabel", "setMoverDerechaTodoLabel" ); // NOI18N
            properties[PROPERTY_moverDerechaTodoLabel].setPreferred ( true );
            properties[PROPERTY_moverDerechaTodoLabel].setDisplayName ( "Etiqueta de Mover Todo a la Derecha" );
            properties[PROPERTY_moverDerechaTodoLabel].setShortDescription ( "Edita la etiqueta de Mover a la Derecha" );
            properties[PROPERTY_moverIzquierdaLabel] = new PropertyDescriptor ( "moverIzquierdaLabel", edu.tecnm.itl.beans.SeleccionBean.class, "getMoverIzquierdaLabel", "setMoverIzquierdaLabel" ); // NOI18N
            properties[PROPERTY_moverIzquierdaLabel].setPreferred ( true );
            properties[PROPERTY_moverIzquierdaLabel].setDisplayName ( "Etiqueta de Mover a la Izquierda" );
            properties[PROPERTY_moverIzquierdaLabel].setShortDescription ( "Modifica la etiqueta del boton Mover a la Izquierda" );
            properties[PROPERTY_moverIzquierdaTodoLabel] = new PropertyDescriptor ( "moverIzquierdaTodoLabel", edu.tecnm.itl.beans.SeleccionBean.class, "getMoverIzquierdaTodoLabel", "setMoverIzquierdaTodoLabel" ); // NOI18N
            properties[PROPERTY_moverIzquierdaTodoLabel].setPreferred ( true );
            properties[PROPERTY_moverIzquierdaTodoLabel].setDisplayName ( "Etiqueta de Mover Todo a la Izquierda" );
            properties[PROPERTY_moverIzquierdaTodoLabel].setShortDescription ( "Edita la etiqueta de mover todo" );
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", edu.tecnm.itl.beans.SeleccionBean.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", edu.tecnm.itl.beans.SeleccionBean.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", edu.tecnm.itl.beans.SeleccionBean.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", edu.tecnm.itl.beans.SeleccionBean.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", edu.tecnm.itl.beans.SeleccionBean.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", edu.tecnm.itl.beans.SeleccionBean.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", edu.tecnm.itl.beans.SeleccionBean.class, "getParent", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", edu.tecnm.itl.beans.SeleccionBean.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", edu.tecnm.itl.beans.SeleccionBean.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", edu.tecnm.itl.beans.SeleccionBean.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", edu.tecnm.itl.beans.SeleccionBean.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", edu.tecnm.itl.beans.SeleccionBean.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", edu.tecnm.itl.beans.SeleccionBean.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_seleccionadoLabel] = new PropertyDescriptor ( "seleccionadoLabel", edu.tecnm.itl.beans.SeleccionBean.class, "getSeleccionadoLabel", "setSeleccionadoLabel" ); // NOI18N
            properties[PROPERTY_seleccionadoLabel].setPreferred ( true );
            properties[PROPERTY_seleccionadoLabel].setDisplayName ( "Etiqueda de Seleccionado" );
            properties[PROPERTY_seleccionadoLabel].setShortDescription ( "Cambia el texto de la etiqueta del seleccionado" );
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", edu.tecnm.itl.beans.SeleccionBean.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", edu.tecnm.itl.beans.SeleccionBean.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", edu.tecnm.itl.beans.SeleccionBean.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", edu.tecnm.itl.beans.SeleccionBean.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", edu.tecnm.itl.beans.SeleccionBean.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", edu.tecnm.itl.beans.SeleccionBean.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", edu.tecnm.itl.beans.SeleccionBean.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", edu.tecnm.itl.beans.SeleccionBean.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", edu.tecnm.itl.beans.SeleccionBean.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", edu.tecnm.itl.beans.SeleccionBean.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", edu.tecnm.itl.beans.SeleccionBean.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", edu.tecnm.itl.beans.SeleccionBean.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", edu.tecnm.itl.beans.SeleccionBean.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", edu.tecnm.itl.beans.SeleccionBean.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", edu.tecnm.itl.beans.SeleccionBean.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", edu.tecnm.itl.beans.SeleccionBean.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", edu.tecnm.itl.beans.SeleccionBean.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", edu.tecnm.itl.beans.SeleccionBean.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.SeleccionBean.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.SeleccionBean.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.SeleccionBean.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.SeleccionBean.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.SeleccionBean.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.SeleccionBean.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.SeleccionBean.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.SeleccionBean.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.SeleccionBean.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.SeleccionBean.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.SeleccionBean.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.SeleccionBean.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.SeleccionBean.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_contadorDisponibles15 = 15;
    private static final int METHOD_contadorSeleccionados16 = 16;
    ...
    private static final int METHOD_llenarListaDisponibles82 = 82;
    private static final int METHOD_llenarListaSeleccionados83 = 83;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_contadorDisponibles15] = new MethodDescriptor(edu.tecnm.itl.beans.SeleccionBean.class.getMethod("contadorDisponibles", new Class[] {})); // NOI18N
            methods[METHOD_contadorDisponibles15].setPreferred ( true );
            methods[METHOD_contadorDisponibles15].setDisplayName ( "Etiqueta del contador de Disponibles" );
            methods[METHOD_contadorDisponibles15].setShortDescription ( "Modifica el texto mostrado en el contador" );
            methods[METHOD_contadorSeleccionados16] = new MethodDescriptor(edu.tecnm.itl.beans.SeleccionBean.class.getMethod("contadorSeleccionados", new Class[] {})); // NOI18N
            methods[METHOD_contadorSeleccionados16].setPreferred ( true );
            methods[METHOD_contadorSeleccionados16].setDisplayName ( "Etiqueta del contador de seleccionados" );
            methods[METHOD_contadorSeleccionados16].setShortDescription ( "Modifica el texto mostrado en el contador" );
            ...
            methods[METHOD_llenarListaDisponibles82] = new MethodDescriptor(edu.tecnm.itl.beans.SeleccionBean.class.getMethod("llenarListaDisponibles", new Class[] {})); // NOI18N
            methods[METHOD_llenarListaDisponibles82].setDisplayName ( "" );
            methods[METHOD_llenarListaSeleccionados83] = new MethodDescriptor(edu.tecnm.itl.beans.SeleccionBean.class.getMethod("llenarListaSeleccionados", new Class[] {})); // NOI18N
            methods[METHOD_llenarListaSeleccionados83].setDisplayName ( "" );
