...
public class AcercaDeBeanBeanInfo extends SimpleBeanInfo
{
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( edu.tecnm.itl.beans.AcercaDeBean.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_arrAgradeciminetos = 5;
    ...
    private static final int PROPERTY_carrera = 12;
    ...
    private static final int PROPERTY_desarrolladoPor = 24;
    private static final int PROPERTY_desarrollador = 25;
    ...
    private static final int PROPERTY_institucion = 58;
    private static final int PROPERTY_keyListeners = 59;
    private static final int PROPERTY_layout = 60;
    private static final int PROPERTY_leyenda = 61;
    ...
    private static final int PROPERTY_logoAbajo = 66;
    private static final int PROPERTY_logoArriba = 67;
    ...
    private static final int PROPERTY_nombreApp = 80;
    ...
    private static final int PROPERTY_universidad = 101;
    private static final int PROPERTY_usarColores = 102;
    ...
    private static final int PROPERTY_versionApp = 106;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleContext] = new PropertyDescriptor ( "accessibleContext", edu.tecnm.itl.beans.AcercaDeBean.class, "getAccessibleContext", null ); // NOI18N
            properties[PROPERTY_actionMap] = new PropertyDescriptor ( "actionMap", edu.tecnm.itl.beans.AcercaDeBean.class, "getActionMap", "setActionMap" ); // NOI18N
            properties[PROPERTY_alignmentX] = new PropertyDescriptor ( "alignmentX", edu.tecnm.itl.beans.AcercaDeBean.class, "getAlignmentX", "setAlignmentX" ); // NOI18N
            properties[PROPERTY_alignmentY] = new PropertyDescriptor ( "alignmentY", edu.tecnm.itl.beans.AcercaDeBean.class, "getAlignmentY", "setAlignmentY" ); // NOI18N
            properties[PROPERTY_ancestorListeners] = new PropertyDescriptor ( "ancestorListeners", edu.tecnm.itl.beans.AcercaDeBean.class, "getAncestorListeners", null ); // NOI18N
            properties[PROPERTY_arrAgradeciminetos] = new PropertyDescriptor ( "arrAgradeciminetos", edu.tecnm.itl.beans.AcercaDeBean.class, "getArrAgradeciminetos", "setArrAgradeciminetos" ); // NOI18N
            properties[PROPERTY_arrAgradeciminetos].setPreferred ( true );
            properties[PROPERTY_arrAgradeciminetos].setDisplayName ( "Agradecimientos" );
            properties[PROPERTY_arrAgradeciminetos].setShortDescription ( "Lineas de agradecimineto a colaboradores" );
            properties[PROPERTY_autoscrolls] = new PropertyDescriptor ( "autoscrolls", edu.tecnm.itl.beans.AcercaDeBean.class, "getAutoscrolls", "setAutoscrolls" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", edu.tecnm.itl.beans.AcercaDeBean.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_backgroundSet] = new PropertyDescriptor ( "backgroundSet", edu.tecnm.itl.beans.AcercaDeBean.class, "isBackgroundSet", null ); // NOI18N
            properties[PROPERTY_baselineResizeBehavior] = new PropertyDescriptor ( "baselineResizeBehavior", edu.tecnm.itl.beans.AcercaDeBean.class, "getBaselineResizeBehavior", null ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", edu.tecnm.itl.beans.AcercaDeBean.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_bounds] = new PropertyDescriptor ( "bounds", edu.tecnm.itl.beans.AcercaDeBean.class, "getBounds", "setBounds" ); // NOI18N
            properties[PROPERTY_carrera] = new PropertyDescriptor ( "carrera", edu.tecnm.itl.beans.AcercaDeBean.class, "getCarrera", "setCarrera" ); // NOI18N
            properties[PROPERTY_carrera].setPreferred ( true );
            properties[PROPERTY_colorModel] = new PropertyDescriptor ( "colorModel", edu.tecnm.itl.beans.AcercaDeBean.class, "getColorModel", null ); // NOI18N
            properties[PROPERTY_component] = new IndexedPropertyDescriptor ( "component", edu.tecnm.itl.beans.AcercaDeBean.class, null, null, "getComponent", null ); // NOI18N
            properties[PROPERTY_componentCount] = new PropertyDescriptor ( "componentCount", edu.tecnm.itl.beans.AcercaDeBean.class, "getComponentCount", null ); // NOI18N
            properties[PROPERTY_componentListeners] = new PropertyDescriptor ( "componentListeners", edu.tecnm.itl.beans.AcercaDeBean.class, "getComponentListeners", null ); // NOI18N
            properties[PROPERTY_componentOrientation] = new PropertyDescriptor ( "componentOrientation", edu.tecnm.itl.beans.AcercaDeBean.class, "getComponentOrientation", "setComponentOrientation" ); // NOI18N
            properties[PROPERTY_componentPopupMenu] = new PropertyDescriptor ( "componentPopupMenu", edu.tecnm.itl.beans.AcercaDeBean.class, "getComponentPopupMenu", "setComponentPopupMenu" ); // NOI18N
            properties[PROPERTY_components] = new PropertyDescriptor ( "components", edu.tecnm.itl.beans.AcercaDeBean.class, "getComponents", null ); // NOI18N
            properties[PROPERTY_containerListeners] = new PropertyDescriptor ( "containerListeners", edu.tecnm.itl.beans.AcercaDeBean.class, "getContainerListeners", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", edu.tecnm.itl.beans.AcercaDeBean.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_cursorSet] = new PropertyDescriptor ( "cursorSet", edu.tecnm.itl.beans.AcercaDeBean.class, "isCursorSet", null ); // NOI18N
            properties[PROPERTY_debugGraphicsOptions] = new PropertyDescriptor ( "debugGraphicsOptions", edu.tecnm.itl.beans.AcercaDeBean.class, "getDebugGraphicsOptions", "setDebugGraphicsOptions" ); // NOI18N
            properties[PROPERTY_desarrolladoPor] = new PropertyDescriptor ( "desarrolladoPor", edu.tecnm.itl.beans.AcercaDeBean.class, "getDesarrolladoPor", "setDesarrolladoPor" ); // NOI18N
            properties[PROPERTY_desarrolladoPor].setPreferred ( true );
            properties[PROPERTY_desarrolladoPor].setDisplayName ( "Desarrollado Por:" );
            properties[PROPERTY_desarrollador] = new PropertyDescriptor ( "desarrollador", edu.tecnm.itl.beans.AcercaDeBean.class, "getDesarrollador", "setDesarrollador" ); // NOI18N
            properties[PROPERTY_desarrollador].setPreferred ( true );
            properties[PROPERTY_displayable] = new PropertyDescriptor ( "displayable", edu.tecnm.itl.beans.AcercaDeBean.class, "isDisplayable", null ); // NOI18N
            properties[PROPERTY_doubleBuffered] = new PropertyDescriptor ( "doubleBuffered", edu.tecnm.itl.beans.AcercaDeBean.class, "isDoubleBuffered", "setDoubleBuffered" ); // NOI18N
            properties[PROPERTY_dropTarget] = new PropertyDescriptor ( "dropTarget", edu.tecnm.itl.beans.AcercaDeBean.class, "getDropTarget", "setDropTarget" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", edu.tecnm.itl.beans.AcercaDeBean.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_focusable] = new PropertyDescriptor ( "focusable", edu.tecnm.itl.beans.AcercaDeBean.class, "isFocusable", "setFocusable" ); // NOI18N
            properties[PROPERTY_focusCycleRoot] = new PropertyDescriptor ( "focusCycleRoot", edu.tecnm.itl.beans.AcercaDeBean.class, "isFocusCycleRoot", "setFocusCycleRoot" ); // NOI18N
            properties[PROPERTY_focusCycleRootAncestor] = new PropertyDescriptor ( "focusCycleRootAncestor", edu.tecnm.itl.beans.AcercaDeBean.class, "getFocusCycleRootAncestor", null ); // NOI18N
            properties[PROPERTY_focusListeners] = new PropertyDescriptor ( "focusListeners", edu.tecnm.itl.beans.AcercaDeBean.class, "getFocusListeners", null ); // NOI18N
            properties[PROPERTY_focusOwner] = new PropertyDescriptor ( "focusOwner", edu.tecnm.itl.beans.AcercaDeBean.class, "isFocusOwner", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", edu.tecnm.itl.beans.AcercaDeBean.class, "isFocusTraversable", null ); // NOI18N
            properties[PROPERTY_focusTraversalKeys] = new IndexedPropertyDescriptor ( "focusTraversalKeys", edu.tecnm.itl.beans.AcercaDeBean.class, null, null, null, "setFocusTraversalKeys" ); // NOI18N
            properties[PROPERTY_focusTraversalKeysEnabled] = new PropertyDescriptor ( "focusTraversalKeysEnabled", edu.tecnm.itl.beans.AcercaDeBean.class, "getFocusTraversalKeysEnabled", "setFocusTraversalKeysEnabled" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicy] = new PropertyDescriptor ( "focusTraversalPolicy", edu.tecnm.itl.beans.AcercaDeBean.class, "getFocusTraversalPolicy", "setFocusTraversalPolicy" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicyProvider] = new PropertyDescriptor ( "focusTraversalPolicyProvider", edu.tecnm.itl.beans.AcercaDeBean.class, "isFocusTraversalPolicyProvider", "setFocusTraversalPolicyProvider" ); // NOI18N
            properties[PROPERTY_focusTraversalPolicySet] = new PropertyDescriptor ( "focusTraversalPolicySet", edu.tecnm.itl.beans.AcercaDeBean.class, "isFocusTraversalPolicySet", null ); // NOI18N
            properties[PROPERTY_font] = new PropertyDescriptor ( "font", edu.tecnm.itl.beans.AcercaDeBean.class, "getFont", "setFont" ); // NOI18N
            properties[PROPERTY_fontSet] = new PropertyDescriptor ( "fontSet", edu.tecnm.itl.beans.AcercaDeBean.class, "isFontSet", null ); // NOI18N
            properties[PROPERTY_foreground] = new PropertyDescriptor ( "foreground", edu.tecnm.itl.beans.AcercaDeBean.class, "getForeground", "setForeground" ); // NOI18N
            properties[PROPERTY_foregroundSet] = new PropertyDescriptor ( "foregroundSet", edu.tecnm.itl.beans.AcercaDeBean.class, "isForegroundSet", null ); // NOI18N
            properties[PROPERTY_graphics] = new PropertyDescriptor ( "graphics", edu.tecnm.itl.beans.AcercaDeBean.class, "getGraphics", null ); // NOI18N
            properties[PROPERTY_graphicsConfiguration] = new PropertyDescriptor ( "graphicsConfiguration", edu.tecnm.itl.beans.AcercaDeBean.class, "getGraphicsConfiguration", null ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", edu.tecnm.itl.beans.AcercaDeBean.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hierarchyBoundsListeners] = new PropertyDescriptor ( "hierarchyBoundsListeners", edu.tecnm.itl.beans.AcercaDeBean.class, "getHierarchyBoundsListeners", null ); // NOI18N
            properties[PROPERTY_hierarchyListeners] = new PropertyDescriptor ( "hierarchyListeners", edu.tecnm.itl.beans.AcercaDeBean.class, "getHierarchyListeners", null ); // NOI18N
            properties[PROPERTY_ignoreRepaint] = new PropertyDescriptor ( "ignoreRepaint", edu.tecnm.itl.beans.AcercaDeBean.class, "getIgnoreRepaint", "setIgnoreRepaint" ); // NOI18N
            properties[PROPERTY_inheritsPopupMenu] = new PropertyDescriptor ( "inheritsPopupMenu", edu.tecnm.itl.beans.AcercaDeBean.class, "getInheritsPopupMenu", "setInheritsPopupMenu" ); // NOI18N
            properties[PROPERTY_inputContext] = new PropertyDescriptor ( "inputContext", edu.tecnm.itl.beans.AcercaDeBean.class, "getInputContext", null ); // NOI18N
            properties[PROPERTY_inputMap] = new PropertyDescriptor ( "inputMap", edu.tecnm.itl.beans.AcercaDeBean.class, "getInputMap", null ); // NOI18N
            properties[PROPERTY_inputMethodListeners] = new PropertyDescriptor ( "inputMethodListeners", edu.tecnm.itl.beans.AcercaDeBean.class, "getInputMethodListeners", null ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", edu.tecnm.itl.beans.AcercaDeBean.class, "getInputMethodRequests", null ); // NOI18N
            properties[PROPERTY_inputVerifier] = new PropertyDescriptor ( "inputVerifier", edu.tecnm.itl.beans.AcercaDeBean.class, "getInputVerifier", "setInputVerifier" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", edu.tecnm.itl.beans.AcercaDeBean.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_institucion] = new PropertyDescriptor ( "institucion", edu.tecnm.itl.beans.AcercaDeBean.class, "getInstitucion", "setInstitucion" ); // NOI18N
            properties[PROPERTY_institucion].setPreferred ( true );
            properties[PROPERTY_keyListeners] = new PropertyDescriptor ( "keyListeners", edu.tecnm.itl.beans.AcercaDeBean.class, "getKeyListeners", null ); // NOI18N
            properties[PROPERTY_layout] = new PropertyDescriptor ( "layout", edu.tecnm.itl.beans.AcercaDeBean.class, "getLayout", "setLayout" ); // NOI18N
            properties[PROPERTY_leyenda] = new PropertyDescriptor ( "leyenda", edu.tecnm.itl.beans.AcercaDeBean.class, "getLeyenda", "setLeyenda" ); // NOI18N
            properties[PROPERTY_leyenda].setPreferred ( true );
            properties[PROPERTY_leyenda].setDisplayName ( "Leyenda Fija" );
            properties[PROPERTY_lightweight] = new PropertyDescriptor ( "lightweight", edu.tecnm.itl.beans.AcercaDeBean.class, "isLightweight", null ); // NOI18N
            properties[PROPERTY_locale] = new PropertyDescriptor ( "locale", edu.tecnm.itl.beans.AcercaDeBean.class, "getLocale", "setLocale" ); // NOI18N
            properties[PROPERTY_location] = new PropertyDescriptor ( "location", edu.tecnm.itl.beans.AcercaDeBean.class, "getLocation", "setLocation" ); // NOI18N
            properties[PROPERTY_locationOnScreen] = new PropertyDescriptor ( "locationOnScreen", edu.tecnm.itl.beans.AcercaDeBean.class, "getLocationOnScreen", null ); // NOI18N
            properties[PROPERTY_logoAbajo] = new PropertyDescriptor ( "logoAbajo", edu.tecnm.itl.beans.AcercaDeBean.class, "getLogoAbajo", "setLogoAbajo" ); // NOI18N
            properties[PROPERTY_logoAbajo].setPreferred ( true );
            properties[PROPERTY_logoArriba] = new PropertyDescriptor ( "logoArriba", edu.tecnm.itl.beans.AcercaDeBean.class, "getLogoArriba", "setLogoArriba" ); // NOI18N
            properties[PROPERTY_logoArriba].setPreferred ( true );
            properties[PROPERTY_managingFocus] = new PropertyDescriptor ( "managingFocus", edu.tecnm.itl.beans.AcercaDeBean.class, "isManagingFocus", null ); // NOI18N
            properties[PROPERTY_maximumSize] = new PropertyDescriptor ( "maximumSize", edu.tecnm.itl.beans.AcercaDeBean.class, "getMaximumSize", "setMaximumSize" ); // NOI18N
            properties[PROPERTY_maximumSizeSet] = new PropertyDescriptor ( "maximumSizeSet", edu.tecnm.itl.beans.AcercaDeBean.class, "isMaximumSizeSet", null ); // NOI18N
            properties[PROPERTY_minimumSize] = new PropertyDescriptor ( "minimumSize", edu.tecnm.itl.beans.AcercaDeBean.class, "getMinimumSize", "setMinimumSize" ); // NOI18N
            properties[PROPERTY_minimumSizeSet] = new PropertyDescriptor ( "minimumSizeSet", edu.tecnm.itl.beans.AcercaDeBean.class, "isMinimumSizeSet", null ); // NOI18N
            properties[PROPERTY_mixingCutoutShape] = new PropertyDescriptor ( "mixingCutoutShape", edu.tecnm.itl.beans.AcercaDeBean.class, null, "setMixingCutoutShape" ); // NOI18N
            properties[PROPERTY_mouseListeners] = new PropertyDescriptor ( "mouseListeners", edu.tecnm.itl.beans.AcercaDeBean.class, "getMouseListeners", null ); // NOI18N
            properties[PROPERTY_mouseMotionListeners] = new PropertyDescriptor ( "mouseMotionListeners", edu.tecnm.itl.beans.AcercaDeBean.class, "getMouseMotionListeners", null ); // NOI18N
            properties[PROPERTY_mousePosition] = new PropertyDescriptor ( "mousePosition", edu.tecnm.itl.beans.AcercaDeBean.class, "getMousePosition", null ); // NOI18N
            properties[PROPERTY_mouseWheelListeners] = new PropertyDescriptor ( "mouseWheelListeners", edu.tecnm.itl.beans.AcercaDeBean.class, "getMouseWheelListeners", null ); // NOI18N
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", edu.tecnm.itl.beans.AcercaDeBean.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_nextFocusableComponent] = new PropertyDescriptor ( "nextFocusableComponent", edu.tecnm.itl.beans.AcercaDeBean.class, "getNextFocusableComponent", "setNextFocusableComponent" ); // NOI18N
            properties[PROPERTY_nombreApp] = new PropertyDescriptor ( "nombreApp", edu.tecnm.itl.beans.AcercaDeBean.class, "getNombreApp", "setNombreApp" ); // NOI18N
            properties[PROPERTY_nombreApp].setPreferred ( true );
            properties[PROPERTY_nombreApp].setDisplayName ( "Nombre Aplicacion" );
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", edu.tecnm.itl.beans.AcercaDeBean.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_optimizedDrawingEnabled] = new PropertyDescriptor ( "optimizedDrawingEnabled", edu.tecnm.itl.beans.AcercaDeBean.class, "isOptimizedDrawingEnabled", null ); // NOI18N
            properties[PROPERTY_paintingForPrint] = new PropertyDescriptor ( "paintingForPrint", edu.tecnm.itl.beans.AcercaDeBean.class, "isPaintingForPrint", null ); // NOI18N
            properties[PROPERTY_paintingTile] = new PropertyDescriptor ( "paintingTile", edu.tecnm.itl.beans.AcercaDeBean.class, "isPaintingTile", null ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", edu.tecnm.itl.beans.AcercaDeBean.class, "getParent", null ); // NOI18N
            properties[PROPERTY_preferredSize] = new PropertyDescriptor ( "preferredSize", edu.tecnm.itl.beans.AcercaDeBean.class, "getPreferredSize", "setPreferredSize" ); // NOI18N
            properties[PROPERTY_preferredSizeSet] = new PropertyDescriptor ( "preferredSizeSet", edu.tecnm.itl.beans.AcercaDeBean.class, "isPreferredSizeSet", null ); // NOI18N
            properties[PROPERTY_propertyChangeListeners] = new PropertyDescriptor ( "propertyChangeListeners", edu.tecnm.itl.beans.AcercaDeBean.class, "getPropertyChangeListeners", null ); // NOI18N
            properties[PROPERTY_registeredKeyStrokes] = new PropertyDescriptor ( "registeredKeyStrokes", edu.tecnm.itl.beans.AcercaDeBean.class, "getRegisteredKeyStrokes", null ); // NOI18N
            properties[PROPERTY_requestFocusEnabled] = new PropertyDescriptor ( "requestFocusEnabled", edu.tecnm.itl.beans.AcercaDeBean.class, "isRequestFocusEnabled", "setRequestFocusEnabled" ); // NOI18N
            properties[PROPERTY_rootPane] = new PropertyDescriptor ( "rootPane", edu.tecnm.itl.beans.AcercaDeBean.class, "getRootPane", null ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", edu.tecnm.itl.beans.AcercaDeBean.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", edu.tecnm.itl.beans.AcercaDeBean.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_toolkit] = new PropertyDescriptor ( "toolkit", edu.tecnm.itl.beans.AcercaDeBean.class, "getToolkit", null ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", edu.tecnm.itl.beans.AcercaDeBean.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_topLevelAncestor] = new PropertyDescriptor ( "topLevelAncestor", edu.tecnm.itl.beans.AcercaDeBean.class, "getTopLevelAncestor", null ); // NOI18N
            properties[PROPERTY_transferHandler] = new PropertyDescriptor ( "transferHandler", edu.tecnm.itl.beans.AcercaDeBean.class, "getTransferHandler", "setTransferHandler" ); // NOI18N
            properties[PROPERTY_treeLock] = new PropertyDescriptor ( "treeLock", edu.tecnm.itl.beans.AcercaDeBean.class, "getTreeLock", null ); // NOI18N
            properties[PROPERTY_UI] = new PropertyDescriptor ( "UI", edu.tecnm.itl.beans.AcercaDeBean.class, "getUI", "setUI" ); // NOI18N
            properties[PROPERTY_UIClassID] = new PropertyDescriptor ( "UIClassID", edu.tecnm.itl.beans.AcercaDeBean.class, "getUIClassID", null ); // NOI18N
            properties[PROPERTY_universidad] = new PropertyDescriptor ( "universidad", edu.tecnm.itl.beans.AcercaDeBean.class, "getUniversidad", "setUniversidad" ); // NOI18N
            properties[PROPERTY_universidad].setPreferred ( true );
            properties[PROPERTY_usarColores] = new PropertyDescriptor ( "usarColores", edu.tecnm.itl.beans.AcercaDeBean.class, null, "setUsarColores" ); // NOI18N
            properties[PROPERTY_usarColores].setPreferred ( true );
            properties[PROPERTY_valid] = new PropertyDescriptor ( "valid", edu.tecnm.itl.beans.AcercaDeBean.class, "isValid", null ); // NOI18N
            properties[PROPERTY_validateRoot] = new PropertyDescriptor ( "validateRoot", edu.tecnm.itl.beans.AcercaDeBean.class, "isValidateRoot", null ); // NOI18N
            properties[PROPERTY_verifyInputWhenFocusTarget] = new PropertyDescriptor ( "verifyInputWhenFocusTarget", edu.tecnm.itl.beans.AcercaDeBean.class, "getVerifyInputWhenFocusTarget", "setVerifyInputWhenFocusTarget" ); // NOI18N
            properties[PROPERTY_versionApp] = new PropertyDescriptor ( "versionApp", edu.tecnm.itl.beans.AcercaDeBean.class, "getVersionApp", "setVersionApp" ); // NOI18N
            properties[PROPERTY_versionApp].setPreferred ( true );
            properties[PROPERTY_versionApp].setDisplayName ( "Version de la App" );
            properties[PROPERTY_vetoableChangeListeners] = new PropertyDescriptor ( "vetoableChangeListeners", edu.tecnm.itl.beans.AcercaDeBean.class, "getVetoableChangeListeners", null ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", edu.tecnm.itl.beans.AcercaDeBean.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_visibleRect] = new PropertyDescriptor ( "visibleRect", edu.tecnm.itl.beans.AcercaDeBean.class, "getVisibleRect", null ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", edu.tecnm.itl.beans.AcercaDeBean.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", edu.tecnm.itl.beans.AcercaDeBean.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", edu.tecnm.itl.beans.AcercaDeBean.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.AcercaDeBean.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.AcercaDeBean.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.AcercaDeBean.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.AcercaDeBean.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.AcercaDeBean.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.AcercaDeBean.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.AcercaDeBean.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.AcercaDeBean.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.AcercaDeBean.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.AcercaDeBean.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.AcercaDeBean.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.AcercaDeBean.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( edu.tecnm.itl.beans.AcercaDeBean.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static final int METHOD_IsUsarColores72 = 72;
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_IsUsarColores72] = new MethodDescriptor(edu.tecnm.itl.beans.AcercaDeBean.class.getMethod("IsUsarColores", new Class[] {})); // NOI18N
            methods[METHOD_IsUsarColores72].setDisplayName ( "" );
