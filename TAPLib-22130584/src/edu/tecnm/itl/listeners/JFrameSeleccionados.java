...
:*                              Bean de Seleccion
:*        
:*  Archivo     : JFrameSeleccionados.java
 ...
 * @author rami
 */
public class JFrameSeleccionados extends javax.swing.JFrame implements SeleccionadosListener
{

    ArrayList<String> datos;

    public JFrameSeleccionados()
    {
        initComponents();
    }
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(JFrameSeleccionados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new JFrameSeleccionados().setVisible(true);
            }
        });
    }
    ...
    public void dispMoverUno(SeleccionadosEvent evento)
    {
        ...
        jLabelContador.setText(datos.get(1));
        jLabelUltimoMovimiento.setText("Ultimo Movimiento: " + datos.get(2));
    }
